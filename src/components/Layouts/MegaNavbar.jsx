    ...
    <nav class="bg-gradient-to-l from-blue-700 via-pink-500 to-blue-700 mx-5 rounded-t-lg hover:shadow-2xl relative">
      <div class="navbar md:h-20 h-44 mx-auto max-w-7xl ">
          <div class="flex flex-col md:flex-row">
              ...
              <div class="md:absolute md:right-10 md:top-5">
                <form onSubmit={getSinglecontact} >
                  <div class="form-control">
                    <div class="relative">
                      <input type="number" class="text-xs md:text-sm input md:w-96 w-72 shadow-2xl pl-16 bg-blue-500 text-white hover:bg-blue-800  rounded-full xl:float-end " placeholder="Search with ID" value={getbyId} onChange={(e) => setGetbyId(e.target.value)} />
